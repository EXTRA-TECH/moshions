            ...
            <div className="home-section u-black u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
              <div className="u-container-layout u-valign-top-lg u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-1">
                <a href="" className="u-enable-responsive u-image u-logo u-image-1" data-image-width="92" data-image-height="41">
                  <img src="/images/MoShiOns_LoGo_White.svg" className="u-logo-image u-logo-image-1" data-image-width="92" />
                </a>
	...
	C52.216,18.553,51.97,16.611,51.911,16.242z"></path><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                ...
                <nav className="u-menu u-menu-dropdown u-offcanvas u-menu-1">
                  ...
                  <div className="u-custom-menu u-nav-container">
                    <ul className="u-nav u-unstyled u-nav-1"><li className="u-nav-item"><a className="u-button-style u-nav-link" href="MEN.html" style={{padding: "16px 22px"}}>MEN</a><div className="u-nav-popup"><ul className="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2"><li className="u-nav-item"><a className="u-button-style u-nav-link u-white" href="">Ishuri collection</a>
</li></ul>
</div>
</li><li className="u-nav-item"><a className="u-button-style u-nav-link" style={{padding: "16px 22px"}}>WOMEN</a><div className="u-nav-popup"><ul className="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-3"><li className="u-nav-item"><a className="u-button-style u-nav-link u-white">Imandwa collection</a>
</li></ul>
</div>
</li><li className="u-nav-item"><a className="u-button-style u-nav-link" style={{padding: "16px 22px"}}>CATEGORIES</a>
</li></ul>
                  </div>
                  <div className="u-custom-menu u-nav-container-collapse">
                    <div className="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                      <div className="u-menu-close"></div>
                      <ul className="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4"><li className="u-nav-item"><a className="u-button-style u-nav-link" href="MEN.html" style={{padding: "16px 22px"}}>MEN</a><div className="u-nav-popup"><ul className="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-5"><li className="u-nav-item"><a className="u-button-style u-nav-link" href="">Ishuri collection</a>
</li></ul>
</div>
</li><li className="u-nav-item"><a className="u-button-style u-nav-link" style={{padding: "16px 22px"}}>WOMEN</a><div className="u-nav-popup"><ul className="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-6"><li className="u-nav-item"><a className="u-button-style u-nav-link">Imandwa collection</a>
</li></ul>
</div>
</li><li className="u-nav-item"><a className="u-button-style u-nav-link" style={{padding: "16px 22px"}}>CATEGORIES</a>
</li></ul>
                ...
                <p className="u-align-center u-text u-text-2">Sample text. Click to select the text box. Click again or double click to start editing the text.</p>
                <a href="#" className="u-btn u-button-style u-white u-btn-1">Discover More</a>
              </div>
            </div>
