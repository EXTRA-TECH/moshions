              ...
              <div className='container'>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    order, however we do not deliver to neighbors or local
                    pick-up points.
                  </p>
                </div>
                ...
                <div className=''>
                  ...
                  <p>
                    Once your order has been placed, it is not possible to
                    change or update the delivery address.
                  </p>
                </div>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    also refuse it altogether. For more information regarding
                    our return policies please review this document.
                  </p>
                </div>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    Merchandise may be returned for exchange or full refund to
                    our store in Kigali – Moshions will take care of the return
                    shipping costs within 15 days of the actual purchase. The
                    item should be accompanied by the printed or email receipt.
                    All merchandise returned for exchange or refund must be in
                    the original packaging and in perfect condition to be
                    accepted. Items such as necklaces, face masks, and
                    personalised orders cannot be returned for hygienic reasons.
                    Kindly check the return eligibility under ‘Return Note’ on
                    the product page.
                  </p>
                </div>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    put this under consideration by attaching a printable
                    version in your return confirmation email.
                  </p>
                </div>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    issued. Depending on your bank, the amount will appear in
                    your bank account details within 7 to 15 days.
                  </p>
                </div>
                ...
                <div className='pb-40'>
                  ...
                  <p>
                    ...
                    the return complies with our return and refund conditions.
                    If it does, we will credit the refund to your original
                    payment method. There may be a slight delay (usually between
                    7 to 15 days) for the amount to appear in your account
                    details depending on your bank. Please note, refunds may
                    only be requested by the customer that placed the original
                    order.
                  </p>
                </div>
              </div>
